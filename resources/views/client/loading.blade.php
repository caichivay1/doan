                ...
                <div class="container">
                    <div class="col-md-3">
                            <ul class="nav nav-pills nav-stacked" style="border:1px solid #e8e8e8">
                                  ...
                                  <li role="presentation"><a href="#">Bài viết chờ duyệt<span style="margin-left: 30px;border-radius:25px;background: #337ab7;padding: 3px 8px;color:white">{{count($posts)}}</span></a></li>
                                  <li role="presentation"><a href="{{route('add_post')}}">Tạo bài viết mới</a></li>
                            </ul>
                    </div>
                    <div class="col-md-9">
                                            <h2 class="text-center" style="color:blue">Bài viết chờ duyệt</h2>
                                    ...
                                    @foreach($posts as $element)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                đã duyệt
                                                @else
                                                <span style="color:blue">đang chờ duyệt</span>
                                                @endif
                                            </td>

                                            <td>
                                                <a href="{{route('edit_post',['id' =>$element->id])}}" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-pencil"></i>
                                                </a>                                                
                                                <a href="javascript:;" id="delete"  onclick ="confirmRemove('{{route('postclient.remove',['id' =>$element->id])}}')" class="btn btn-sm btn-danger client_delete">
