<form class="login-form" action="{{route('client')}}" method="post">
			{{csrf_field()}}
		...
		<div class="form-actions">
			...
			<button type="submit" class="btn default pull-right">
				<a href="{{URL::previous()}}"><i class="m-icon-swapleft"></i>Back</a>
	...
	<form class="forget-form" action="{{route('forgrt-pwd.email')}}" method="post">
		{{csrf_field()}}
	...
	<form class="register-form" action="{{route('register_client')}}" method="post">
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Enter your Name</label>
			<div class="input-icon">
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Thành phố</label>
						<select name="province1" id="province" class="form-control select2">
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Quận</label>
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Phường</label>
						<select id="ward" name="ward1" class="form-control select2">
